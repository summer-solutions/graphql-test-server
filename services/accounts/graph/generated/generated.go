...
func (ec *executionContext) _Entity_findUserByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖsummerᚑsolutionsᚋgraphqlᚑtestᚑserverᚋservicesᚋaccountsᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_me(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.User)
	fc.Result = res
	return ec.marshalOUser2ᚖsummerᚑsolutionsᚋgraphqlᚑtestᚑserverᚋservicesᚋaccountsᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNUser2summerᚑsolutionsᚋgraphqlᚑtestᚑserverᚋservicesᚋaccountsᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚖsummerᚑsolutionsᚋgraphqlᚑtestᚑserverᚋservicesᚋaccountsᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOUser2ᚖsummerᚑsolutionsᚋgraphqlᚑtestᚑserverᚋservicesᚋaccountsᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._User(ctx, sel, v)
